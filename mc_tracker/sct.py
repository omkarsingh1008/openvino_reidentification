    ...
    def _continue_tracks(self, detections, features):
        ...
        if cost_matrix.size > 0:
            ...
            for i, j in zip(row_ind, col_ind):
                ...
                if cost_matrix[i, j] < self.match_threshold and self._check_velocity_constraint(self.tracks[idx].get_last_box(),self.tracks[idx].get_end_time(),detections[i], self.time) and \
