...
from utils.visualization_detection import visualize_multicam_detections, get_target_size
...
def run(params, config, capture, detector, reid):
    ...
    while thread_body.process:
        ...
        vis = visualize_multicam_detections(prev_frames, all_detections, fps,
...
def main():
    ...
    parser.add_argument('--t_detector', type=float, default=0.3,
